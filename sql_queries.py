...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplay_table (songplay_id serial PRIMARY KEY, start_time bigint, user_id varchar, level varchar, song_id varchar, artist_id varchar, session_id int, location varchar, user_agent varchar)""")
...
artist_table_create = ("""CREATE TABLE IF NOT EXISTS artist_table (artist_id varchar PRIMARY KEY, name varchar, location varchar, latitude numeric NULL, longitude numeric NULL)
""")
